...
import javaapp.lr8.task1.example2.FileReader;
...
public class Example2 {
    ...
    public static void main(String[] args) throws IOException{
        ...
        try{
            InputStream inFile = new FileInputStream("D:/JavaProj/JavaApp/src/main/java/javaapp/lr8/task1/example2/text.txt");
