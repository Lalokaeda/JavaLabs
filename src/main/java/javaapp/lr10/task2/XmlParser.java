...
public class XmlParser {
    ...
    public Document parse() {
        try {
            File inputFile = new File("src\\main\\java\\javaapp\\lr10\\task2\\Animals.xml");
    ...
    public void addAnimal(String type, String name, String dateOfBirth, String gender) throws TransformerException {
        ...
        StreamResult result = new StreamResult(new File("src\\main\\java\\javaapp\\lr10\\task2\\Animals.xml"));
